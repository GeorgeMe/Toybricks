...
public class DownloadService extends Service {
	...
	// 存放下载文件的文件夹路径
	public final static String DOWNLOAD_PATH = Const.TOYBRICKS_PATH;

	public final static String DOWNLOAD_ACTION_START = "ACTION_START";
	public final static String DOWNLOAD_ACTION_STOP = "ACTION_STOP";
	public final static String DOWNLOAD_ACTION_UPDATE = "ACTION_UPDATE";
	public final static String DOWNLOAD_ACTION_FINISH = "ACTION_FINISH";
	public final static String DOWNLOAD_ACTION_EXCEPTION = "ACTION_EXCEPTION";
	public final static int MSG_INIT = 0;

	public final static String TAG="DownloadInitThread";
	/**
	 * 下载任务集合
	 */
		...
		public void handleMessage(Message msg) {
			switch (msg.what) {
				case MSG_INIT:
					...
					Log.e("DownloadService", "文件大小 = " + size+ "字节, KB = " + size_kb + ", MB = " + size_mb);
		...
		if (intent!=null){
			if (intent.getAction()!=null){
				...
				if (DOWNLOAD_ACTION_START.equals(intent.getAction())) {
					Log.e("Service, onStartCommand", "开始下载");
					...
					if (null != downloadTask) {
						...
						Log.e("Service, onStartCommand", "停止下载文件："+fileInfo.getFileName());
					}else{
		...
		public void run() {
			...
			try {
				...
				if (e instanceof MalformedURLException){
					...
					intent.putExtra(Const.EXCEPTION_KEY, "ERROR_MALFORMEDURLEXCEPTION");
					intent.putExtra(Const.ID_KEY, mFileInfo.getId());
					// 发送广播
					sendBroadcast(intent);
				}else if (e instanceof ProtocolException){
					Intent intent = new Intent(DownloadService.DOWNLOAD_ACTION_EXCEPTION);
					intent.putExtra(Const.EXCEPTION_KEY, "ERROR_PROOTOCOLEXCEPTION");
					intent.putExtra(Const.ID_KEY, mFileInfo.getId());
					// 发送广播
					sendBroadcast(intent);
